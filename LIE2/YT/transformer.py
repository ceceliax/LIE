...
#
# ##未考虑batch
# # class get_pos_encoding(nn.Module):
# #     def __init__(self, max_sen_len, embed_dim, dropout):
# #         super().__init__()
...
# #             [
# #                 np.sin(pos / np.power(10000, 2 * i / embed_dim)) if i % 2 == 0
# #                 else np.cos(pos / np.power(10000, 2*i/embed_dim))
# #                 for i in range(embed_dim)
# #             ]
# #             for pos in range(max_sen_len)
# #         ])
# #         self.pos_embed = torch.from_numpy(pos_encoding)
# #
# #     def forward(self, x):
# #         """
# #         Args:
