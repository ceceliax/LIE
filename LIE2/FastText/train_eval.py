...
num_epochs=1000
save_path =  './data/fasttext.ckpt'
class_list = [x.strip() for x in open(
             'F:\研二\LIE\BERT\data\chinese_intent_class.txt', encoding='utf-8').readlines()]
require_improvement = 300
save_path2 = './data/fasttext2.ckpt'

def train( model, train_iter, dev_iter, test_iter, learning_rate):
