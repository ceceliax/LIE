...
# with open('train.pkl', 'ab') as f:
#     pkl.dump(vocab, f)

def build_dataset(vocab_path, train_path,dev_path,test_path,pad_size,n_gram_vocab,use_word):
    if use_word:
        tokenizer = lambda x: x.split(' ')  # 以空格隔开，word-level  ##词级别
    else:
        tokenizer = lambda x: [y for y in x]  # char-level  ##字级别
...
#     '''提取预训练词向量'''
#     vocab_dir = "./data/train.pkl"
#     pretrain_dir = "./THUCNews/data/sgns.sogou.char"
#     emb_dim = 300
#     filename_trimmed_dir = "./data/vocab.embedding.sougou"
