import torch
from chinese_intent.process_data import all_data, embed_data, get_dataloder,get_news_label_embed
import os
...
trainxlsx = r'./data/train.xlsx'
testxlsx = r'./data/test.xlsx'
devxlsx = r'./data/dev.xlsx'
...
x_train_embed = embed_data(traindata, max_sen)
x_val_embed = embed_data(devdata, max_sen)
x_test_embed = embed_data(testdata, max_sen)


train_dataloader = get_dataloder(x_train_embed, trainlabel, batch_size)
dev_dataloader = get_dataloder(x_val_embed, devlabel, batch_size)
test_dataloader = get_dataloder(x_test_embed, testlabel, batch_size)
